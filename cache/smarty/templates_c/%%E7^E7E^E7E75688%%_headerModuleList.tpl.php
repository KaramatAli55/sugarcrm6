...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'themes/Sugar/tpls/_headerModuleList.tpl', 19, false),array('function', 'sugar_link', 'themes/Sugar/tpls/_headerModuleList.tpl', 57, false),array('function', 'sugar_ajax_url', 'themes/Sugar/tpls/_headerModuleList.tpl', 74, false),)), $this); ?>
<?php $this->assign('underscore', '_'); ?>

<script type="text/javascript">
sugar_theme_gm_current = '<?php echo ((is_array($_tmp=$this->_tpl_vars['currentGroupTab'])) ? $this->_run_mod_handler('replace', true, $_tmp, ' ', '_') : smarty_modifier_replace($_tmp, ' ', '_')); ?>
';
Set_Cookie('sugar_theme_gm_current','<?php echo ((is_array($_tmp=$this->_tpl_vars['currentGroupTab'])) ? $this->_run_mod_handler('replace', true, $_tmp, ' ', '_') : smarty_modifier_replace($_tmp, ' ', '_')); ?>
',30,'/','','');
</script>
