 ...
 */
SUGAR.DefineTimeExpression=function(params){this.init(params);}
...
SUGAR.util.extend(SUGAR.HourOfDayExpression,SUGAR.TimeExpression,{className:"HourOfDayExpression",evaluate:function(){var time=this.getParameters().evaluate();return new Date(time).getHours();},getParamCount:function(){return 1;}});SUGAR.ContainsExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.ContainsExpression,SUGAR.BooleanExpression,{className:"ContainsExpression",evaluate:function(){var params=this.getParameters();var haystack=params[0].evaluate()+"";var needle=params[1].evaluate();return(haystack.indexOf(needle)>-1?SUGAR.expressions.Expression.TRUE:SUGAR.expressions.Expression.FALSE);},getParamCount:function(){return 2;},getParameterTypes:function(){return'string';}});SUGAR.StrToLowerExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.StrToLowerExpression,SUGAR.StringExpression,{className:"StrToLowerExpression",evaluate:function(){var string=this.getParameters().evaluate()+"";return string.toLowerCase();}});SUGAR.ConcatenateExpression=function(params){this.init(params);}
...
return concat;}});SUGAR.SubStrExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.SubStrExpression,SUGAR.StringExpression,{className:"SubStrExpression",evaluate:function(){var params=this.getParameters();var str=params[0].evaluate()+"";var fromIdx=params[1].evaluate();var strLength=params[2].evaluate();return str.substr(fromIdx,strLength);},getParamCount:function(){return 3;},getParameterTypes:function(){return['string','number','number'];}});SUGAR.FormatedNameExpression=function(params){this.init(params);}
...
return name;},getParamCount:function(){return 4;}});SUGAR.DefineStringExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.DefineStringExpression,SUGAR.StringExpression,{className:"DefineStringExpression",evaluate:function(){return this.getParameters().evaluate()+"";},getParamCount:function(){return 1;},getParameterTypes:function(){return['generic'];}});SUGAR.CharacterAtExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.CharacterAtExpression,SUGAR.StringExpression,{className:"CharacterAtExpression",evaluate:function(){var params=this.getParameters();var str=params[0].evaluate()+"";var idx=params[1].evaluate();return str.charAt(idx);},getParamCount:function(){return 2;},getParameterTypes:function(){return['string','number'];}});SUGAR.SugarTranslateExpression=function(params){this.init(params);}
...
module="app_strings";var key=params[0].evaluate();return SUGAR.language.get(module,key);},getParamCount:function(){return 2;}});SUGAR.StrToUpperExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.StrToUpperExpression,SUGAR.StringExpression,{className:"StrToUpperExpression",evaluate:function(){var string=this.getParameters().evaluate()+"";return string.toUpperCase();}});SUGAR.SugarDropDownValueExpression=function(params){this.init(params);}
...
return arr[i];}
return"";},getParamCount:function(){return 2;}});SUGAR.DefineEnumExpression=function(params){this.init(params);}
...
return ret;},getParamCount:function(){return 1;},getParameterTypes:function(){return'string';}});SUGAR.IsInEnumExpression=function(params){this.init(params);}
...
return SUGAR.expressions.Expression.FALSE;},getParamCount:function(){return 2;},getParameterTypes:function(){return['generic','enum'];}});SUGAR.IsValidDBNameExpression=function(params){this.init(params);}
...
return SUGAR.expressions.Expression.FALSE;},getParamCount:function(){return 1;}});SUGAR.IsAlphaNumericExpression=function(params){this.init(params);}
...
return SUGAR.expressions.Expression.TRUE;}});SUGAR.IsRequiredCollectionExpression=function(params){this.init(params);}
...
return SUGAR.expressions.Expression.FALSE;}}
return SUGAR.expressions.Expression.TRUE;},getParamCount:function(){return 1;},getParameterTypes:function(){return['string'];}});SUGAR.IsValidTimeExpression=function(params){this.init(params);}
...
return SUGAR.expressions.Expression.TRUE;},getParamCount:function(){return 1;},getParameterTypes:function(){return['string'];}});SUGAR.GreaterThanExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.GreaterThanExpression,SUGAR.BooleanExpression,{className:"GreaterThanExpression",evaluate:function(){var params=this.getParameters();var a=params[0].evaluate();var b=params[1].evaluate();if(a>b)return SUGAR.expressions.Expression.TRUE;return SUGAR.expressions.Expression.FALSE;},getParamCount:function(){return 2;},getParameterTypes:function(){return['number','number'];}});SUGAR.OrExpression=function(params){this.init(params);}
...
return SUGAR.expressions.Expression.FALSE;}});SUGAR.EqualExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.EqualExpression,SUGAR.BooleanExpression,{className:"EqualExpression",evaluate:function(){var params=this.getParameters();var a=params[0].evaluate();var b=params[1].evaluate();if(a==b)return SUGAR.expressions.Expression.TRUE;return SUGAR.expressions.Expression.FALSE;},getParamCount:function(){return 2;},getParameterTypes:function(){return['generic','generic'];}});SUGAR.BinaryDependencyExpression=function(params){this.init(params);}
...
return SUGAR.expressions.Expression.TRUE;return SUGAR.expressions.Expression.FALSE;},getParamCount:function(){return 2;},getParameterTypes:function(){return['string','string'];}});SUGAR.IsValidPhoneExpression=function(params){this.init(params);}
...
return SUGAR.expressions.Expression.FALSE;return SUGAR.expressions.Expression.TRUE;},getParamCount:function(){return 1;},getParameterTypes:function(){return['string'];}});SUGAR.IsInRangeExpression=function(params){this.init(params);}
...
return SUGAR.expressions.Expression.TRUE;return SUGAR.expressions.Expression.FALSE;},getParamCount:function(){return 3;},getParameterTypes:function(){return['number','number','number'];}});SUGAR.IsValidDateExpression=function(params){this.init(params);}
...
return SUGAR.expressions.Expression.TRUE;return SUGAR.expressions.Expression.FALSE;},getParamCount:function(){return 1;},getParameterTypes:function(){return['string'];}});SUGAR.IsAlphaExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.IsAlphaExpression,SUGAR.BooleanExpression,{className:"IsAlphaExpression",evaluate:function(){var params=this.getParameters().evaluate();if(/^[a-zA-Z]+$/.test(params))return SUGAR.expressions.Expression.TRUE;return SUGAR.expressions.Expression.FALSE;},getParamCount:function(){return 1;},getParameterTypes:function(){return['string'];}});SUGAR.StringLengthExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.StringLengthExpression,SUGAR.NumericExpression,{className:"StringLengthExpression",evaluate:function(){var p=this.getParameters().evaluate()+"";return p.length;},getParamCount:function(){return 1;},getParameterTypes:function(){return'string';}});SUGAR.MedianExpression=function(params){this.init(params);}
...
return values[Math.round(values.length/2)-1];}});SUGAR.AverageRelatedExpression=function(params){this.init(params);}
...
{return SUGAR.forms.AssignmentHandler.getRelatedField(linkField,'rollupAve',relField);}else if(typeof(rel)=="object"){}
...
SUGAR.util.extend(SUGAR.CeilingExpression,SUGAR.NumericExpression,{className:"CeilingExpression",evaluate:function(){return Math.ceil(this.getParameters().evaluate());},getParamCount:function(){return 1;}});SUGAR.NaturalLogExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.NaturalLogExpression,SUGAR.NumericExpression,{className:"NaturalLogExpression",evaluate:function(){return Math.log(this.getParameters().evaluate());},getParamCount:function(){return 1;}});SUGAR.PowerExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.PowerExpression,SUGAR.NumericExpression,{className:"PowerExpression",evaluate:function(){var params=this.getParameters();var base=params[0].evaluate();var power=params[1].evaluate();return Math.pow(base,power);},getParamCount:function(){return 2;}});SUGAR.MaxRelatedExpression=function(params){this.init(params);}
...
{return SUGAR.forms.AssignmentHandler.getRelatedField(linkField,'rollupMax',relField);}else if(typeof(rel)=="object"){}
return"";},getParamCount:function(){return 2;},getParameterTypes:function(){return['relate','string'];}});SUGAR.CountRelatedExpression=function(params){this.init(params);}
...
return"";},getParamCount:function(){return 1;},getParameterTypes:function(){return['relate'];}});SUGAR.StandardDeviationExpression=function(params){this.init(params);}
...
deviation_sum+=Math.pow(values[i]-mean,2);var variance=(1/count)*deviation_sum;return Math.sqrt(variance);}});SUGAR.AverageExpression=function(params){this.init(params);}
...
return(sum / count);}});SUGAR.MinimumExpression=function(params){this.init(params);}
...
min=val;}
return min;}});SUGAR.MultiplyExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.MultiplyExpression,SUGAR.NumericExpression,{className:"MultiplyExpression",evaluate:function(){var params=this.getParameters();var product=1;for(var i=0;i<params.length;i++)product*=params[i].evaluate();return product;}});SUGAR.LogExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.LogExpression,SUGAR.NumericExpression,{className:"LogExpression",evaluate:function(){var params=this.getParameters();var base=params[1].evaluate();var value=params[0].evaluate();return Math.log(value)/ Math.log(base);},getParamCount:function(){return 2;}});SUGAR.NegateExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.NegateExpression,SUGAR.NumericExpression,{className:"NegateExpression",evaluate:function(){return-1*this.getParameters().evaluate();},getParamCount:function(){return 1;}});SUGAR.MinRelatedExpression=function(params){this.init(params);}
...
{return SUGAR.forms.AssignmentHandler.getRelatedField(linkField,'rollupMin',relField);}else if(typeof(rel)=="object"){}
return"";},getParamCount:function(){return 2;},getParameterTypes:function(){return['relate','string'];}});SUGAR.FloorExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.FloorExpression,SUGAR.NumericExpression,{className:"FloorExpression",evaluate:function(){return Math.floor(this.getParameters().evaluate());},getParamCount:function(){return 1;}});SUGAR.SubtractExpression=function(params){this.init(params);}
...
{return SUGAR.forms.AssignmentHandler.getRelatedField(linkField,'rollupSum',relField);}else if(typeof(rel)=="object"){}
return"";},getParamCount:function(){return 2;},getParameterTypes:function(){return['relate','string'];}});SUGAR.MaximumExpression=function(params){this.init(params);}
...
max=val;}
return max;}});SUGAR.ValueOfExpression=function(params){this.init(params);}
...
throw"Error: '"+val+"' is not a number";return out;},getParamCount:function(){return 1;},getParameterTypes:function(){return'generic';}});SUGAR.AbsoluteValueExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.AbsoluteValueExpression,SUGAR.NumericExpression,{className:"AbsoluteValueExpression",evaluate:function(){return Math.abs(this.getParameters().evaluate());},getParamCount:function(){return 1;}});SUGAR.IndexOfExpression=function(params){this.init(params);}
...
return-1;},getParamCount:function(){return 2;},getParameterTypes:function(){return['generic','enum'];}});SUGAR.DivideExpression=function(params){this.init(params);}
...
throw"Devision by 0 error";return numerator/denominator;},getParamCount:function(){return 2;}});SUGAR.AddExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.AddExpression,SUGAR.NumericExpression,{className:"AddExpression",evaluate:function(){var params=this.getParameters();var sum=0;for(var i=0;i<params.length;i++)sum+=params[i].evaluate();return sum;}});SUGAR.ConditionExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.ConditionExpression,SUGAR.GenericExpression,{className:"ConditionExpression",evaluate:function(){var params=this.getParameters();var cond=params[0].evaluate();if(cond==SUGAR.expressions.Expression.TRUE){return params[1].evaluate();}else{return params[2].evaluate();}},getParamCount:function(){return 3;},getParameterTypes:function(){return['boolean','generic','generic'];}});SUGAR.RelatedFieldExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.RelatedFieldExpression,SUGAR.GenericExpression,{className:"RelatedFieldExpression",evaluate:function(){var params=this.getParameters(),linkField=params[0].evaluate(),relField=params[1].evaluate(),AH=SUGAR.forms.AssignmentHandler;if(typeof(linkField)=="string"&&linkField!="")
{var module=AH.getValue("module");var record=AH.getValue("record");var linkDef=AH.getLink(linkField);var linkId=false,url="index.php?";if(linkDef&&linkDef.id_name&&linkDef.module){var idField=document.getElementById(linkDef.id_name);if(idField&&(idField.tagName=="INPUT"||idField.hasAttribute("data-id-value")))
...
return AH.getRelatedField(linkField,'related',relField);}else if(typeof(rel)=="object"){}
return"";},getParamCount:function(){return 2;},getParameterTypes:function(){return['relate','string'];}});SUGAR.IndexValueExpression=function(params){this.init(params);}
...
throw("value_at: Attempt to access an index out of bounds");return array[index];},getParamCount:function(){return 2;},getParameterTypes:function(){return['number','enum'];}});SUGAR.SugarFieldExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.SugarFieldExpression,SUGAR.GenericExpression,{className:"SugarFieldExpression",evaluate:function(){var varName=this.getParameters().evaluate();return SUGAR.forms.AssignmentHandler.getValue(varName);},getParamCount:function(){return 1;},getParameterTypes:function(){return['string'];}});SUGAR.DayOfWeekExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.DayOfWeekExpression,SUGAR.NumericExpression,{className:"DayOfWeekExpression",evaluate:function(){var time=this.getParameters().evaluate();var date=getDateObject(time);if(date){return date.getDay();}
return"";},getParamCount:function(){return 1;},getParameterTypes:function(){return['date'];}});SUGAR.DaysUntilExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.DaysUntilExpression,SUGAR.NumericExpression,{className:"DaysUntilExpression",evaluate:function(){var then=SUGAR.util.DateUtils.parse(this.getParameters().evaluate(),'user');var now=new Date();then.setHours(0);then.setMinutes(0);then.setSeconds(0);var diff=then-now;var days=Math.ceil(diff / 86400000);return days;},getParamCount:function(){return 1;},getParameterTypes:function(){return['date'];}});SUGAR.NowExpression=function(params){this.init(params);}
...
SUGAR.util.extend(SUGAR.TodayExpression,SUGAR.DateExpression,{className:"TodayExpression",evaluate:function(){var d=new Date();d.setHours(0);d.setMinutes(0);d.setSeconds(0);return d;},getParamCount:function(){return 0;}});SUGAR.AddDaysExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.AddDaysExpression,SUGAR.DateExpression,{className:"AddDaysExpression",evaluate:function(){var params=this.getParameters();var date=SUGAR.util.DateUtils.parse(params[0].evaluate(),'user');var days=params[1].evaluate();var d=new Date(date);d.setDate(d.getDate()+days);return d;},getParamCount:function(){return 2;},getParameterTypes:function(){return['date','number'];}});SUGAR.MonthOfYearExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.MonthOfYearExpression,SUGAR.NumericExpression,{className:"MonthOfYearExpression",evaluate:function(){var time=this.getParameters().evaluate();var date=getDateObject(time);if(date){return date.getMonth()+1;}
return"";},getParamCount:function(){return 1;},getParameterTypes:function(){return['date'];}});SUGAR.DefineDateExpression=function(params){this.init(params);}
SUGAR.util.extend(SUGAR.DefineDateExpression,SUGAR.DateExpression,{className:"DefineDateExpression",evaluate:function(){var params=this.getParameters().evaluate();var time=SUGAR.util.DateUtils.parse(params,'user');if(time==false)throw"Incorrect date format";return time;},getParamCount:function(){return 1;},getParameterTypes:function(){return['string'];}});SUGAR.forms.ReadOnlyAction=function(target,expr){this.target=target;this.expr=expr;}
...
D.setStyle(trig,'display','');}});SUGAR.forms.SetValueAction=function(target,valExpr){this.expr=valExpr;this.target=target;};SUGAR.util.extend(SUGAR.forms.SetValueAction,SUGAR.forms.AbstractAction,{exec:function(context)
...
SUGAR.forms.AssignmentHandler.setStyle(this.target,temp);}catch(e){return;}}});SUGAR.forms.SetRequiredAction=function(variable,expr,label){this.variable=variable;this.expr=expr;this.label=label;this._el_lbl=document.getElementById(this.label);this.msg=this._el_lbl.innerText;}
...
return i;}}
return-1;}});SUGAR.forms.PanelVisibilityAction=function(target,expr)
{var targetElement=YAHOO.util.Dom.getAncestorByTagName(target,"div");this.target=YAHOO.util.Dom.getAttribute(targetElement,"id");this.expr='cond('+expr+', "", "none")';}
...
{var t=document.getElementById(target);if(t==null)return;t.style.overflow="hidden";t.style.height="0px";t.style.display="";var expandAnim=new YAHOO.util.Anim(target,{height:{to:SUGAR.forms.animation.sizes[target]}},0.5,YAHOO.util.Easing.easeBoth);expandAnim.onComplete.subscribe(function(){t.style.height='auto';});expandAnim.animate();};SUGAR.forms.SetOptionsAction=function(target,keyExpr,labelExpr){this.keyExpr=keyExpr;this.labelExpr=labelExpr;this.target=target;};SUGAR.util.extend(SUGAR.forms.SetOptionsAction,SUGAR.forms.AbstractAction,{exec:function(context){if(typeof(context)=='undefined')
context=this.context;view=false;if(typeof(context.formName)!='undefined')
view=context.formName;var field=SUGAR.forms.AssignmentHandler.getElement(this.target,view);if(field==null)return null;var keys=this.evalExpression(this.keyExpr,context);var labels=this.evalExpression(this.labelExpr,context);var selected='';if(keys instanceof Array&&field.options!=null)
...
else if(keys instanceof Array&&(keys.length==0||(keys.length==1&&keys[0]==''))){var va=new SUGAR.forms.VisibilityAction(this.target,'false','');va.exec(context);}}});SUGAR.forms.VisibilityAction=function(target,expr,view)
...
el.style.display=hide?'none':'';}});SUGAR.forms.AssignToUserAction=function(valExpr){this.expr=valExpr;this.target='assigned_user_name';this.dataSource=new YAHOO.util.DataSource('index.php?',{responseType:YAHOO.util.XHRDataSource.TYPE_JSON,responseSchema:{resultsList:'fields',total:'totalCount',metaNode:'fields',metaFields:{total:'totalCount',fields:'fields'}},connMethodPost:true});};SUGAR.util.extend(SUGAR.forms.AssignToUserAction,SUGAR.forms.AbstractAction,{exec:function(context)
{if(typeof(context)=='undefined')
context=this.context;var userName=this.evalExpression(this.expr,context);var params=SUGAR.util.paramsToUrl({to_pdf:'true',module:'Home',action:'quicksearchQuery',data:YAHOO.lang.JSON.stringify(sqs_objects['EditView_'+this.target]),query:userName});this.sqs=sqs_objects['EditView_'+this.target];this.dataSource.sendRequest(params,{success:function(param,resp){if(resp.results.length>0)
{var match=resp.results[0];for(var i=0;i<this.sqs.field_list.length;i++)
{SUGAR.forms.AssignmentHandler.assign(this.sqs.populate_list[i],match[this.sqs.field_list[i]]);}}},scope:this});},targetUrl:'index.php?module=Home&action=TaxRate&to_pdf=1'});SUGAR.FunctionMap={'time':SUGAR.DefineTimeExpression,'hourOfDay':SUGAR.HourOfDayExpression,'contains':SUGAR.ContainsExpression,'strToLower':SUGAR.StrToLowerExpression,'concat':SUGAR.ConcatenateExpression,'subStr':SUGAR.SubStrExpression,'formatName':SUGAR.FormatedNameExpression,'toString':SUGAR.DefineStringExpression,'string':SUGAR.DefineStringExpression,'charAt':SUGAR.CharacterAtExpression,'translateLabel':SUGAR.SugarTranslateExpression,'translate':SUGAR.SugarTranslateExpression,'strToUpper':SUGAR.StrToUpperExpression,'getDropdownValue':SUGAR.SugarDropDownValueExpression,'getDDValue':SUGAR.SugarDropDownValueExpression,'createList':SUGAR.DefineEnumExpression,'enum':SUGAR.DefineEnumExpression,'getDropdownKeySet':SUGAR.SugarDropDownExpression,'getDD':SUGAR.SugarDropDownExpression,'getDropdownValueSet':SUGAR.SugarTranslatedDropDownExpression,'getTransDD':SUGAR.SugarTranslatedDropDownExpression,'isInList':SUGAR.IsInEnumExpression,'isInEnum':SUGAR.IsInEnumExpression,'isValidDBName':SUGAR.IsValidDBNameExpression,'isNumeric':SUGAR.IsNumericExpression,'not':SUGAR.NotExpression,'isAlphaNumeric':SUGAR.IsAlphaNumericExpression,'isBefore':SUGAR.isBeforeExpression,'and':SUGAR.AndExpression,'isRequiredCollection':SUGAR.IsRequiredCollectionExpression,'isAfter':SUGAR.isAfterExpression,'isValidEmail':SUGAR.IsValidEmailExpression,'isValidTime':SUGAR.IsValidTimeExpression,'greaterThan':SUGAR.GreaterThanExpression,'or':SUGAR.OrExpression,'equal':SUGAR.EqualExpression,'doBothExist':SUGAR.BinaryDependencyExpression,'isValidPhone':SUGAR.IsValidPhoneExpression,'isWithinRange':SUGAR.IsInRangeExpression,'isValidDate':SUGAR.IsValidDateExpression,'isAlpha':SUGAR.IsAlphaExpression,'strlen':SUGAR.StringLengthExpression,'median':SUGAR.MedianExpression,'rollupAve':SUGAR.AverageRelatedExpression,'ceil':SUGAR.CeilingExpression,'ceiling':SUGAR.CeilingExpression,'ln':SUGAR.NaturalLogExpression,'pow':SUGAR.PowerExpression,'rollupMax':SUGAR.MaxRelatedExpression,'count':SUGAR.CountRelatedExpression,'stddev':SUGAR.StandardDeviationExpression,'average':SUGAR.AverageExpression,'min':SUGAR.MinimumExpression,'multiply':SUGAR.MultiplyExpression,'log':SUGAR.LogExpression,'negate':SUGAR.NegateExpression,'rollupMin':SUGAR.MinRelatedExpression,'floor':SUGAR.FloorExpression,'subtract':SUGAR.SubtractExpression,'rollupSum':SUGAR.SumRelatedExpression,'max':SUGAR.MaximumExpression,'number':SUGAR.ValueOfExpression,'abs':SUGAR.AbsoluteValueExpression,'indexOf':SUGAR.IndexOfExpression,'divide':SUGAR.DivideExpression,'add':SUGAR.AddExpression,'ifElse':SUGAR.ConditionExpression,'cond':SUGAR.ConditionExpression,'related':SUGAR.RelatedFieldExpression,'valueAt':SUGAR.IndexValueExpression,'sugarField':SUGAR.SugarFieldExpression,'dayofweek':SUGAR.DayOfWeekExpression,'daysUntil':SUGAR.DaysUntilExpression,'now':SUGAR.NowExpression,'today':SUGAR.TodayExpression,'addDays':SUGAR.AddDaysExpression,'monthofyear':SUGAR.MonthOfYearExpression,'date':SUGAR.DefineDateExpression};SUGAR.NumericConstants={'pi':3.1415926535898,'e':2.718281828459};